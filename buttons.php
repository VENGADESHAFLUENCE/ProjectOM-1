...
<!--close-top-Header-menu-->
		...
		<div id="sidebar">
			<a href="#" class="visible-phone"><i class="icon icon-tint"></i> Buttons &amp; icons</a><ul>
					...
					<div class="span12">
                        <div class="widget-box">
							...
							<div class="widget-content">
                                    ...
                                    <h5>Mini Buttons </h5><code>(class="btn btn-mini")</code>
									<p>
									...
									<h4>General Buttons </h4><code>(class="btn")</code>
									<p>
									...
									<h3>Large Buttons </h3><code>(class="btn btn-large")</code>
									<p>
