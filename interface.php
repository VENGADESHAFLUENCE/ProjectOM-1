...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-pencil"></i> Interface elements</a>
  <ul>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Interface elements</a> </div>
      ...
      <div class="span12">
		...
		<div class="widget-box">
          ...
          <div class="widget-content">
            ...
            <li><a title="" id="example" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-placement="top" data-toggle="popover" class="btn btn-success" href="" data-original-title="Popover on top">Popover on top</a>
            </li>
            <li><a title="" id="example2" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-placement="right" data-toggle="popover" class="btn btn-success" href="" data-original-title="Popover on right">Popover on right</a>
            </li>
            <li><a title="" id="example3" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-placement="bottom" data-toggle="popover" class="btn btn-success" href="" data-original-title="Popover on bottom">Popover on bottom</a>
            </li>
            <li><a title="" id="example4" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-placement="left" data-toggle="popover" class="btn btn-success" href="" data-original-title="Popover on left">Popover on left</a>
            </li>
          </ul>
          </div>
          </div>        
